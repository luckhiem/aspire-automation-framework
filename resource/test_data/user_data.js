...
import { generateNumber, generateUEN } from '../../src/utils/Utils';

const user1 = new User();
user1.name = name.findName();
user1.email = internet.exampleEmail();
user1.phone = generateNumber();
user1.otp = 123456;
